...
field 'autoupdate.architecture."32bit".url' "https://downloads.mixxx.org/mixxx-\$version/mixxx-\$version-win32.exe"
field 'autoupdate.architecture."64bit".url' "https://downloads.mixxx.org/mixxx-\$version/mixxx-\$version-win64.exe"
#autofill_download
...
pre_install <<-EOF
	dark -nologo -sw -sct -sdet -sui -x "\$dir\\\\\$1" "\$dir\\\\setup.exe" NUL | Out-Null
	$(ps_install_extra_file mixxx.mst "\$dir\\\\mixxx.mst")
